...
def get_polyaxon_dataroot(dir="", data_node="ceph", use_local=False):
    ...
    datauser@192.168.68.79:/dataset(上传至ceph存储，代码中可使用get_data_paths()['ceph']访问)
...
if __name__ == "__main__":
    val_src_root = "/media/data/dm/FaceRecognition/torch-Face-Recognize-Pipeline/data/val/"
    local_val_root = "/media/data/dm/FaceRecognition/torch-Face-Recognize-Pipeline/data/val1/val"
    val_name = "X4"
