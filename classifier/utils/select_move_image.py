...
def select_sub_image_dir(image_root, dst_root, max_nums=10, shuffle=True):
    ...
    # sub_file = "/home/data/nasdata/dataset-data/handwriting/word-class/trainval/class_name699.txt"
...
def demo_select_image():
    targer_dir = "/home/data/data3/dataset/finger_keypoint/finger/val/annotations/val"
    search_dir = "/home/data/data3/dataset/finger_keypoint/finger/images"
    dest_dir = "/home/data/data3/dataset/finger_keypoint/finger/val/images"
    # select_image_dir_search(targer_dir, search_dir, dest_dir)
    select_image_dir(targer_dir, search_dir, dest_dir)


if __name__ == "__main__":
    image_dir = "/home/data/nasdata/dataset/csdn/animal/animals10/train"
    dst_root = "/home/data/nasdata/dataset/csdn/animal/animals10/test"
